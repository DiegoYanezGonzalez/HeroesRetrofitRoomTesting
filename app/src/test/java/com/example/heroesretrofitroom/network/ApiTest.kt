package com.example.heroesretrofitroom.network

import com.example.heroesretrofitroom.model.network.SuperHeroeApi
import com.example.heroesretrofitroom.model.pojos.*
...
class ApiTest {
    ...
    fun getAllSuperHeroes_happy_case() = runBlocking {
        ...
        Truth.assertThat(request.path).isEqualTo("/all.json")
    }
